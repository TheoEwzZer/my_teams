...
** the team, that have the channel, that have the thread,
** that got the new reply
*/
...
/**
** @brief Must be called when the current
** logged user receives a private message
...
** ex: asking the teams you are subscribed
** to or the available teams in a domain
